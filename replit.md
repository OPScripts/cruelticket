...
- **Transcript Feature:**
  ...
  - Transcripts sent to ticket creator via DM
  - Transcripts also posted to configured logs channel for record-keeping
...
- **Permission System:**
  - Complete ticket requires Administrator permission OR roles set via `/setup-roles`
  - Cancel ticket requires ticket creator, Administrator, OR roles set via `/setup-roles`
  - Non-permitted users receive message: "Ticket marked complete. Only the Mods/Admins can finalize this ticket"
